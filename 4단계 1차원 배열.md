...
- [2562. 최댓값](#2562-최댓값)
- [10810. 공 넣기](#10810-공-넣기)
- [10813. 공 바꾸기](#10813-공-바꾸기)
...
## 문제풀이
```
const [nm, ...ij] = require('fs').readFileSync('/dev/stdin').toString().trim().split('\n');
const n = nm.split(' ')[0]; // 바구니 개수
let arr = Array(+n).fill(0).map((_, i) => i + 1); // [0, 0, 0, 0, 0] => [1, 2, 3, 4, 5]
console.log(ij.reduce((result, v) => {
